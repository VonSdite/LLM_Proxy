...
class ModelMappingSchemaTests(unittest.TestCase):
    ...
    def test_mapping_editor_uses_target_actions_and_unclipped_dropdown(self) -> None:
        ...
        self.assertIn("mapping-help-popover-header", template)
        self.assertIn("mapping-help-popover-title", template)
        self.assertIn("mapping-help-popover-close", template)
        self.assertIn("mapping-help-popover-body", template)
        ...
        self.assertIn("width: min(360px, calc(100vw - 24px))", stylesheet)
        self.assertIn(".mapping-help-popover-body code", stylesheet)
        self.assertIn("color: #c2185b", stylesheet)
