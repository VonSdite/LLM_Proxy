...
class ModelMappingSchemaTests(unittest.TestCase):
    ...
    def test_mapping_editor_uses_target_actions_and_unclipped_dropdown(self) -> None:
        ...
        admin_base_css = (project_root / "src/presentation/static/css/admin-base.css").read_text(encoding="utf-8")
        settings_template = (project_root / "src/presentation/templates/settings.html").read_text(encoding="utf-8")

        self.assertIn("model_mappings.css?v=20260918-1", template)
        ...
        self.assertIn('id="mappingHelpPopover"', template)
        self.assertIn("help-popover-header", template)
        self.assertIn("help-popover-title", template)
        self.assertIn("help-popover-close", template)
        self.assertIn("help-popover-body", template)
        self.assertIn("function toggleMappingHelp", template)
        self.assertIn("function positionMappingHelpPopover", template)
        self.assertIn("initMappingHelpInteractions", template)
        ...
        self.assertNotIn("临时冷却", priority_header_markup)
        self.assertNotIn("自动禁用", priority_header_markup)
        ...
        self.assertIn(".mapping-help-button", stylesheet)
        self.assertIn(".app-page .help-popover {", admin_base_css)
        self.assertIn("width: min(460px, calc(100vw - 24px))", admin_base_css)
        self.assertIn(".app-page .help-popover-body code", admin_base_css)
        self.assertIn("color: #c2185b", admin_base_css)
        self.assertNotIn(".mapping-help-tooltip", stylesheet)
        ...
        self.assertIn("settings.css?v=20260918-1", settings_template)
