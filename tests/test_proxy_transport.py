...
class ProviderTemplateTransportTests(unittest.TestCase):
    ...
    def test_oauth_template_contains_oauth_workflows(self) -> None:
        ...
        self.assertNotIn('id="codexDisableSelectedAuthFilesBtn"', html)
        ...
        self.assertNotIn('id="claudeDisableSelectedAuthFilesBtn"', html)
        ...
        self.assertNotIn("function disableSelectedClaudeAuthFiles", html)
        self.assertNotIn("function disableSelectedCodexAuthFiles", html)
