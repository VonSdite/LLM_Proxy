...
class ProviderTemplateTransportTests(unittest.TestCase):
    def test_provider_template_contains_clean_provider_fields_and_help(self) -> None:
        ...
        self.assertIn(':root[data-theme="dark"] .providers-page .provider-modal-tabs {', css)
        self.assertIn(':root[data-theme="dark"] .providers-page .provider-modal-tab-btn {', css)
        self.assertIn(':root[data-theme="dark"] .providers-page .provider-modal-tab-btn.is-active {', css)
