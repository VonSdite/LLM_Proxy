...
class ProviderController:
    ...
    def _register_routes(self) -> None:
        ...
        self._app.route(
            "/api/auth-groups/<string:name>/entries/<string:entry_id>/reset-minute-usage", methods=["POST"]
    ...
    def reorder_providers(self) -> ResponseReturnValue:
        try:
            ...
            self._logger.info("Provider order updated: count=%s", result.get("count", 0))
