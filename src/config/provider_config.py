...
AUTH_GROUP_STRATEGY_LEAST_INFLIGHT = "least_inflight"
AUTH_GROUP_STRATEGY_STICKY_FAILOVER = "sticky_failover"
DEFAULT_AUTH_GROUP_STRATEGY = AUTH_GROUP_STRATEGY_LEAST_INFLIGHT
DEFAULT_AUTH_GROUP_COOLDOWN_SECONDS_ON_429 = 60
SUPPORTED_PROVIDER_API_SCHEMES = {"http", "https"}
SUPPORTED_AUTH_GROUP_STRATEGIES = {
    AUTH_GROUP_STRATEGY_LEAST_INFLIGHT,
